...
{
	alt_putstr("ABCDE\n")
	//alt_putstr("Initializeren van mixer...\n");
	for (int i = 0; i < 4; i++)
	{
	...
	alt_putstr("beginpositie instellen...\n");
	for (int i = 0; i < 5; i++)
	{
	  IOWR(PIO_0_BASE, 0x00, 0x3);
	  usleep(500000);
	...
	IOWR(ALT_VIP_CL_MIXER_0_BASE, REG_MIX_IN0_XOFFSET , 10);
	IOWR(ALT_VIP_CL_MIXER_0_BASE, REG_MIX_IN0_YOFFSET , 10);

	alt_putstr("consume input 0...\n");
	for (int i = 0; i < 6; i++)
	{
	  IOWR(PIO_0_BASE, 0x00, 0x3);
	  usleep(500000);
	...
	alt_putstr("enable en consume input 0...\n");
	for (int i = 0; i < 6; i++)
	{
	  IOWR(PIO_0_BASE, 0x00, 0x3);
	  usleep(500000);
